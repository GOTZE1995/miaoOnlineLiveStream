											...
											<div class="profile-content">
												...
												<div class="phone-group">			
														<div class="cell-form">
																...
																<input type="text" value="小明" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '小明';}">	
												...
												<div class="phone-group">			
														<div class="cell-form">
																...
																<input type="text" value="四班" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '四班';}">	
		...
		<!-- Tab 2 -->					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
											<div class="hobby">
												...
												<div class="hobby-info" margin-top="80px">
													<a href="tv-register.jsp"><h5>申请直播间</h5></a>
													<br/>
													<br/>
													<a href="gallery.jsp"><h5>进入直播间</h5></a>	
													<br/>
													<br/>
													<a href="myTVinfo.jsp"><h5>编辑直播间</h5></a>													
												</div>
											</div>
										</div>	
									</div>	
