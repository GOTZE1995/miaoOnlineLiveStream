...
<link href="css-info/style.css" rel="stylesheet" type="text/css" media="all"/>
<!--script-->
...
<div class="main">
						...
						<div >
							<div class="port-left">
								...
								<form action="" method="post">
									  	<div class="fileInputContainer"><input class="fileInput" type="file" name=""></div>
								</form>
		...
		<!-- Tab 0 -->					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
											...
											<h3>${user.userName}</h3>
												<form action="${pageContext.request.contextPath}/user/edit.do" method="post" id="editMyInfo">								
												<h4>邮箱账号</h4>
												<div class="email-group">
														<div class="email-form">
															<input type="text" id="email" name="email" value="${user.email}" onblur="checkNewEmail()" onfocus="renewEmailState()"/>	
															<br/><span id="spanEmail"></span>
														</div>
														<div class="clear"></div>
												</div>
												<h4>昵称</h4>	
												<div class="phone-group">			
														<div class="cell-form">
															<input id="nickName" type="text" name="nickName" value="${user.nickName}" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '${user.nickName}';}">		
														</div>
														<div class="clear"></div>
												</div>
												...
												<div class="phone-group">			
														<div class="cell-form">
															<input type="text" name="classId" value="四班" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '四班';}">			
														</div>
												</div>
												<br/>
												<br/>
												<br/>
												 <input type="button" value="更新" onclick="doSubmit()" />
	...
	<!-- Tab 1 -->						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">		
											<div class="social">
												<h3>Mark Carter </h3>
													<form action="${pageContext.request.contextPath}/user/editPwd.do" method="post" id="editMyInfo">	
														<div class="password-info">
															
															<h4>当前密码：</h4>
															<div class="cell-form" style="width:446px">
															<input type="text" id="password" name="nowPwd" onblur="checkNowPwd()" onfocus="renewPwdState()"/><span id="spanPassword"></span>
															</div>
		...
		<!-- Tab 2 -->					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
											<div class="hobby">
												...
												<div class="hobby-info" margin-top="80px">
													...
													<form action="${pageContext.request.contextPath}/room/updateRoomState.do" method="post">
