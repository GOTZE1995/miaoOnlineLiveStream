	...
	<body style="width: 1349px">
					...
					<div class="callbacks_container">
						<ul class="rslides" id="slider">
							<li>
								...
								<div class="readmore">
									<a href="${basePath }room/findRoom">马上体验<i
							...
							<li>
								<h3>聊天室</h3>
								<p>聊天室(chat
									room)是一个网上空间，为了保证谈话的焦点，聊天室通常有一定的谈话主题。任何一个联入Internet、使用正确的聊天软件，并且渴望谈论的人都可以享受其乐趣。在课上学生和教师能有更多的学术交流</p>
								<div class="readmore">
									<a href="about.jsp">马上体验<i
										class="glyphicon glyphicon-menu-right"> </i></a>
								</div>
							</li>
							<li>
		...
		<div class="welcome" style="width: 1349px;">
			<div class="container">
				...
				<p>Education began in the earliest prehistory, as adults trained
					the young in the knowledge and skills deemed necessary in their
					society. In pre-literate societies this was achieved orally and
					through imitation. Story-telling passed knowledge,</p>
			</div>
		</div>
		<!--effect-grid-->
