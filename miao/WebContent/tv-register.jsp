...
<div class="main">
		...
		<!-- Tab 0 -->					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
											<div class="profile-content">
												<h3>${user.userName}</h3>
												<form action="${pageContext.request.contextPath}/room/registMyRoom.do" method="post">								
												<h4>房间名称</h4>	
												<div class="phone-group">			
														<div class="cell-form">

																<input type="text" name="roomName" value="xx直播间" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xx直播间';}">	
												...
												<div class="email-group">
														<div class="email-form">
																...
																<input type="text" name="phone" class="fb-ico" value="12345678" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'markcarter@gmail.com';}">	
												...
												<div class="phone-group">			
														<div class="cell-form">
															<textarea name="memo" rows="4" cols="49" placeholder="可以输入多行文本"></textarea>
														</div>
														<div class="clear"></div>
												</div>
												<!-- 直播间的所属用户 -->
												<input type="hidden" name="user.userName" class="InputStyle" value="${user.userName}"/>
												<h4>直播分类</h4>
												<div class="phone-group">
													<div class="cell-form">
      													<select>
      													...
      													<input style="margin-left:0px" type="submit" value="确认申请"/>
    												</div>
												</div>
												</form>
											</div>
