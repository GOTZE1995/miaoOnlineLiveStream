...
<body>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> 权限列表
			</div>
		</div>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="power/listUI.do" method="get">
	...
	<div id="MainArea">
				...
				<c:if test="${not empty powerList }">
					<c:forEach var="power" varStatus="stu" items="${page.list}">
						<tr align="center" class="TableDetail1">
							...
							<td><a href="power/updateUI.do?id=${power.powerId }"
								class="FunctionButton">更新</a> <a
								href="power/delete.do?id=${power.powerId }"
		...
		<table width="100%" class="pageDown" border="0" cellspacing="0"
			cellpadding="0">
			<tr>
				<td align="right">总共${page.totalCount }条记录，当前第
					${page.currentPageNum } 页，共 ${page.totalPageNum } 页 &nbsp;&nbsp; <a
					href="power/listUI.do?currentPage=${page.prePageNum }">上一页</a>&nbsp;&nbsp;<a
					href="power/listUI.do?currentPage=${page.nextPageNum }">下一页</a>
					&nbsp;&nbsp;
				</td>
			</tr>
		</table>
