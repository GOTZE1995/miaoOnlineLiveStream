...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="style/images/title_arrow.gif"/> 更新用户
				...
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							<td>角色</td>
							<td>
							<input type="radio" name="role.roleName" value="教师"  />教师
							<input type="radio" name="role.roleName" value="学生"  />学生
							<input type="radio" name="role.roleName" value="管理员" />管理员
			                </td>
						</tr>
