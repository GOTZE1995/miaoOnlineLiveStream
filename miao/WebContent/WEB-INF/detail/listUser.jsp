				...
				<c:if test="${not empty userList }">
					<c:forEach var="user" varStatus="stu" items="${page.list}">
						<tr align="center" class="TableDetail1">
							...
							<td><a href="user/updateUI.do?id=${user.id }"
								class="FunctionButton">更新</a> <a
								href="user/delete.do?id=${user.id }"
		...
		<table width="100%" class="pageDown" border="0" cellspacing="0"
			...
			<tr>
				<td align="right">总共${page.totalCount }条记录，当前第
					...
					href="user/listUI.do?currentPage=${page.prePageNum }">上一页</a>&nbsp;&nbsp;<a
					href="user/listUI.do?currentPage=${page.nextPageNum }">下一页</a>
					&nbsp;&nbsp;
				</td>
			</tr>
		</table>
