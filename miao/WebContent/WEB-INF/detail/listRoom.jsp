		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> 直播间列表
			</div>
		</div>
				...
				<c:if test="${not empty roomList }">
					<c:forEach var="room" varStatus="stu" items="${page.list}">
						<tr align="center" class="TableDetail1">
							...
							<td>${room.status }&nbsp;</td>
							<td>${room.url }&nbsp;</td>
							<td><a href="room/updateUI.do?id=${room.id }"
								class="FunctionButton">更新</a> <a
								href="room/delete.do?id=${room.id}"
		...
		<table width="100%" class="pageDown" border="0" cellspacing="0"
			...
			<tr>
				<td align="right">总共${page.totalCount }条记录，当前第
					...
					href="room/listUI.do?currentPage=${page.prePageNum }">上一页</a>&nbsp;&nbsp;<a
					href="room/listUI.do?currentPage=${page.nextPageNum }">下一页</a>
					&nbsp;&nbsp;
				</td>
			</tr>
		</table>
