...
<body>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="style/images/title_arrow.gif" /> 角色列表
			</div>
		</div>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="role/listUI.do" method="get">
				...
				<c:if test="${not empty roleList }">
					<c:forEach var="role" varStatus="stu" items="${page.list}">
						<tr align="center" class="TableDetail1">
							...
							<td>${role.roleName }&nbsp;</td>
							<td>权限&nbsp;</td>
							<td><a href="role/updateUI.do?id=${role.roleId }"
								class="FunctionButton">更新</a> <a
								href="role/delete.do?id=${role.roleId }"
		...
		<table width="100%" class="pageDown" border="0" cellspacing="0"
			...
			<tr>
				<td align="right">总共${page.totalCount }条记录，当前第
					...
					href="role/listUI.do?currentPage=${page.prePageNum }">上一页</a>&nbsp;&nbsp;<a
					href="role/listUI.do?currentPage=${page.nextPageNum }">下一页</a>
					&nbsp;&nbsp;
				</td>
			</tr>
		</table>
